// Small lib to parse and plot nhmmer.table files
...
/// The static path to the tables produced.
...
impl MitoGene {
    ...
    pub fn iterator() -> Iter<'static, MitoGene> {
        ...
        use self::MitoGene::*;
        static MITOGENES: [MitoGene; 36] = [
            Atp1, Atp4, Atp6, Atp8, Atp9, CcmB, CcmC, CcmF, Cob, Cox1, Cox2, Cox3, MatR, MttB,
            Nad1, Nad2, Nad3, Nad4, Nad5, Nad6, Nad7, Nad9, Rpl2, Rpl5, Rpl10, Rpl16, Rps1, Rps3,
            Rps4, Rps10, Rps12, Rps13, Rps14, Rps19, Sdh3, Sdh4,
        ];
        MITOGENES.iter()
    }
}
